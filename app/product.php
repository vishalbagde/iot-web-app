                        ...
                        <div class="modal-body">
							...
							<div class="form-group">
                                ...
                                <select name="tax_id" id="tax_id" class="form-control" required>
                                    ...
                                    <?php echo fill_tax_list();?>
                                </select>
                            </div>
							
                            <div class="form-group">
                                <label>Enter Product Tax (%)</label>
                                <input type="text" name="tax_rate" id="tax_rate" class="form-control" required pattern="[+-]?([0-9]*[.])?[0-9]+" />
                            </div>
                        </div>
    ...
    $(document).on('click', '.update', function(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $('#product_quantity').val(data.product_qty);
